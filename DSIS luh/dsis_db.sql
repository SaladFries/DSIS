...
CREATE TABLE `accounttbl` (
  ...
  `AcctUsername` varchar(50) NOT NULL,
  `AcctPassword` varchar(15) NOT NULL
...
INSERT INTO `accounttbl` (`AcctID`, `Acct_LastName`, `Acct_FirstName`, `Acct_MI`, `Acct_Type`, `Acct_Status`, `PHFID`, `AcctUsername`, `AcctPassword`) VALUES
(1, 'Dela Cruz', 'Juan', 'C', 1, 1, 1, 'bhw', 'bhw123'),
(2, 'Canay', 'Monalyn', 'A', 2, 1, 1, 'rhu', 'rhu123');
...
CREATE TABLE `patientinfotbl` (
  ...
  `Patient_Suffix` varchar(50) DEFAULT NULL,
  ...
  `Patient_Preggers` varchar(10) DEFAULT NULL,
  `Patient_Preggers_Weeks` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `patientinfotbl`
--

INSERT INTO `patientinfotbl` (`Patient_ID`, `Patient_LastName`, `Patient_FirstName`, `Patient_MI`, `Patient_Suffix`, `Patient_Bgy`, `Patient_Muni`, `Patient_Province`, `Patient_Bday`, `Patient_Gender`, `Patient_Preggers`, `Patient_Preggers_Weeks`) VALUES
(1, 'Canay', 'Marvin Glenn', 'A', '', 'Dili', 'Gasan', 'Marinduque', '1993-02-07', 'M', '', 0),
(2, 'Dela Cruz', 'Juan', 'A', 'Jr.', 'Santol', 'Boac', 'Marinduque', '1990-01-01', 'Male', NULL, NULL);
...
CREATE TABLE `potential_suspect_tbl` (
  ...
  `Patient_ID` int(10) NOT NULL,
  `AcctID` int(10) NOT NULL,
  `potential_suspect_symptoms` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `potential_suspect_tbl`
--

INSERT INTO `potential_suspect_tbl` (`PotentialSuspect_ID`, `Notifiable_Disease_ID`, `Patient_ID`, `AcctID`, `potential_suspect_symptoms`) VALUES
(1, 17, 1, 1, 'fever'),
(2, 20, 2, 2, 'Neck Pain, Malaise');
...
--
-- Dumping data for table `publichealthfacilitytbl`
--

INSERT INTO `publichealthfacilitytbl` (`PHFID`, `PHFName`, `PHFBgy`, `PHFMunicipality`, `PHFProvince`, `PHFArea`) VALUES
(1, 'Gasan Rural Health Unit', 'Barangay I', 'Gasan', 'Marinduque', 'Gasan');
...
ALTER TABLE `potential_suspect_tbl`
  ...
  ADD KEY `Notifiable_Disease_ID` (`Notifiable_Disease_ID`),
  ADD KEY `Patient_ID` (`Patient_ID`,`AcctID`),
...
ALTER TABLE `potential_suspect_tbl`
  ...
  ADD CONSTRAINT `potential_suspect_tbl_ibfk_2` FOREIGN KEY (`Patient_ID`) REFERENCES `patientinfotbl` (`Patient_ID`),
  ADD CONSTRAINT `potential_suspect_tbl_ibfk_3` FOREIGN KEY (`AcctID`) REFERENCES `accounttbl` (`AcctID`);
