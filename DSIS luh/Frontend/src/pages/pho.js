...
const facilities = ['RHU Boac I', 'RHU Boac II','RHU Gasan', 'RHU Mogpog', 'RHU Santa Cruz I', 'RHU Santa Cruz II','RHU Buenavista', 'RHU Torijos'];
...
const UserScreen = ({ userType, onLogout }) => {
  ...
  const [dashboardData, setDashboardData] = useState({
    ...
    recoveredCases: 30,
    recentReports: [
      { id: 1, patient: 'John Doe', address: '123 Main St', healthFacility: 'RHU Boac I', disease: 'COVID-19', date: '2024-10-15' },
        ...
        {activeSection === 'home' && (
          <div className="dashboard" style={{ width: '100%', display: 'flex', gap: '2rem' }}>
            <div className="welcome-message" style={{ flex: 1 }}>
              <h2>DSIS Dashboard Report and Updates ...</h2>
